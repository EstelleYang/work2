package com.lzjs.uappoint.magicimage;
...
public class MagicMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(MagicMainActivity.this);
        dialog = builder.setTitle("提示")
                ...
                .setPositiveButton("保存", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // save picture
                        saveImageToGallery(MagicMainActivity.this, copy);
                        dialog.dismiss();
                    }
                })
    ...
    public void shareSingleImage() {
        if(copy != null){
            ...
            Toast.makeText(MagicMainActivity.this, "请先从图库选择一张图片", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void saveImageToGallery(Context context, Bitmap bmp) {
        ...
        Toast.makeText(MagicMainActivity.this, "图片已保存至" + path, Toast.LENGTH_SHORT).show();
        // 最后通知图库更新
    ...
    private void selectImage(){
        MultiImageSelector.create(MagicMainActivity.this)
                .showCamera(true) // 是否显示相机. 默认为显示
//                .count(1) // 最大选择图片数量, 默认为9. 只有在选择模式为多选时有效
                .single() // 单选模式
//                .multi() // 多选模式, 默认模式;
//                .origin(ArrayList<String>) // 默认已选择图片. 只有在选择模式为多选时有效
                .start(MagicMainActivity.this, REQUEST_IMAGE);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.tv_trans:// 半透明
                ...
                break;
            case R.id.image:
                if (ActivityCompat.checkSelfPermission(MagicMainActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    // 应用没有读取手机外部存储的权限
                    // 申请WRITE_EXTERNAL_STORAGE权限
                    ActivityCompat.requestPermissions(MagicMainActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
                            100);
                }else {
                    selectImage();
                }
                    ...
                    public void Succ(String res) {
                        ...
                        if(result != null){
                            if(result.getErrorcode() == 0){
                                ...
                                Toast.makeText(MagicMainActivity.this, result.getErrormsg(), Toast.LENGTH_SHORT).show();
            ...
            case R.id.tv_change:
                if(bitmap != null){
                    ...
                    Toast.makeText(MagicMainActivity.this, "please select a picture first", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
        ...
        dialogInfo = builder.setTitle("识别成功")
                ...
                .setPositiveButton("复制号码", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(MagicMainActivity.this, "身份证号已复制到粘贴板", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                })
