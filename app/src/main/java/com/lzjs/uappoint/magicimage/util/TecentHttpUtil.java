package com.lzjs.uappoint.magicimage.util;

import android.util.Log;

import com.lzjs.uappoint.magicimage.constant.Constant;
import com.lzjs.uappoint.magicimage.entity.IdentifyResult;
import com.lzjs.uappoint.magicimage.sign.YoutuSign;
...
public class TecentHttpUtil {
    ...
    public static void uploadIdCard(String bitmap, String card_type, final SimpleCallBack callback) {
        ...
        RequestParams params = new RequestParams(Constant.YouTuUrl);
