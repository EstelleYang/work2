 ...
 * @author shalei
 */
public class DatePickDialogUtil extends AlertDialog implements DialogInterface.OnClickListener, OnDateChangedListener {
     ...
     */
    public DatePickDialogUtil(Context context, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
        this(context, 0, callBack, year, monthOfYear, dayOfMonth);
    }

    public DatePickDialogUtil(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
                                  int dayOfMonth) {
    ...
    public DatePickDialogUtil(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
        ...
        View view = inflater.inflate(R.layout.common_date, null);
        setView(view);
        mDatePicker_start = (DatePicker) view.findViewById(R.id.datePicker);
