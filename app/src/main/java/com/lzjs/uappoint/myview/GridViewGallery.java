...
public class GridViewGallery extends LinearLayout {
    ...
    private void initDots() {
        ...
        int col = (width/160) >2 ? (width/160) :4;
        int row = (high/400) >4?(high/400):4;
        ...
        if (0 < viewPager_size) {
            ...
            if (1 == viewPager_size) {
                ...
                for (int j = 0; j < viewPager_size; j++) {
                    ...
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(5, 5);  //dot的宽高
    ...
    private View getViewPagerItem(int index) {
        ...
        int width = Util.getWindowWidth(context);
        int col = 4;//(width / 160) > 2 ? (width / 160) : 4;
